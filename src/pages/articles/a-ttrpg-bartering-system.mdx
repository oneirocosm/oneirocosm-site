...
<MathWarning>
First, remember that when you roll a die, any result is the same. So we can say that:

<div class="text-center">d6 = 7 - d6</div>

Which is just a fancy way to say a 1 is the same as 7 - 6. A 2 is the same as 7 - 5. And so on.
With this, I can do this fancy trick:
